/*
  surveysez-04302015.sql 

  Our first version of the SurveySez project tables
...
DROP TABLE IF EXISTS sp15_users;
...
INSERT INTO sp15_surveys VALUES (NULL,1,'Our First Survey','Description of Survey',NOW(),NOW()); 
...
INSERT INTO sp15_users VALUES (NULL,1,'bobsmith','bob@smith.com','Bob','Smith',48,'Male','Seattle','Bachelor\'s Degree',40000,NOW(),NOW());
