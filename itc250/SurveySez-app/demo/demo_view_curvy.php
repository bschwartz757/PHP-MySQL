<?php
/**
 * demo_view_curvy.php along with demo_list_curvy.php demonstrates
...
<p>This page, along with <b>demo_list_curvy.php</b>, demonstrate a List/View web application.</p>
...
<p>This page is to be used only with <b>demo_list_curvy.php</b>, and is <b>NOT</b> the entry point of the application, meaning this page gets <b>NO</b> link on your web site.</p>
<p>Use <b>demo_list_curvy.php</b> and <b>demo_view_curvy.php</b> as a starting point for building your own List/View web application!</p>
...
?>
	...
	<div align="center"><a href="<?=VIRTUAL_PATH; ?>demo/demo_list_curvy.php">More Muffins?!?</a></div>
	<table align="center">
		<tr>
			<td><img src="<?=VIRTUAL_PATH; ?>upload/m<?=$myID;?>.jpg" />
					<?php
...
<?
    ...
    echo '<div align="center"><a href="' . VIRTUAL_PATH . 'demo/demo_list_curvy.php">Another Muffin?</a></div>';
}
