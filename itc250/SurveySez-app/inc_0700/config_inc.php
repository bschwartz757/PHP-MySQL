...
define('VIRTUAL_PATH', 'http://blakehschwartz.com/sp15/'); # Virtual (web) 'root' of application for images, JS & CSS files
define('PHYSICAL_PATH', '/home/blasch13/blakehschwartz.com/sp15/'); # Physical (PHP) 'root' of application for file & upload reference
...
define('SUPPORT_EMAIL', 'blakehschwartz@gmail.com'); # Email of site support
define('PREFIX', 'sp15_'); #Prefix to add uniqueness to your DB table names.  Limits hackability, naming collisions
...
$config->slogan = 'Is it a Yeti?';
$config->metaDescription = 'Welcome to the Yeti website. We like cotlets, but Yetis are more unusual.';
$config->metaKeywords = 'Yetis,Sasquatches,Abominable Snowpeople,database,mysql,php';
$config->metaRobots = 'no index, no follow';
$config->banner = 'No Yestis please...'; #goes inside header - can be overwritten
$config->copyright = 'Yetis, not Bigfeet, &copy; 2014 - ' . date('Y'); #goes inside footer - can be overwritten
